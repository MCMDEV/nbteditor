...
public class NBTEditor {
    ...
    public static void main(String[] args) {
        ...
        itemNew = new JMenuItem("New", new ImageIcon(Utils.getImage("/page.png")));
        itemOpen = new JMenuItem("Open...", new ImageIcon(Utils.getImage("/folder_page.png")));
        itemReload = new JMenuItem("Reload", new ImageIcon(Utils.getImage("/arrow_rotate_clockwise.png")));
        itemSave = new JMenuItem("Save...", new ImageIcon(Utils.getImage("/disk.png")));
        itemSaveAs = new JMenuItem("Save as...", new ImageIcon(Utils.getImage("/disk_go.png")));
        itemQuit = new JMenuItem("Quit", new ImageIcon(Utils.getImage("/door.png")));
        itemCut = new JMenuItem("Cut", new ImageIcon(Utils.getImage("/cut.png")));
        itemCopy = new JMenuItem("Copy", new ImageIcon(Utils.getImage("/page_white_copy.png")));
        itemPaste = new JMenuItem("Paste", new ImageIcon(Utils.getImage("/page_paste.png")));
        itemDelete = new JMenuItem("Delete", new ImageIcon(Utils.getImage("/cross.png")));
        itemRename = new JMenuItem("Rename", new ImageIcon(Utils.getImage("/textfield_rename.png")));
        itemEdit = new JMenuItem("Edit...", new ImageIcon(Utils.getImage("/pencil.png")));
        itemMoveUp = new JMenuItem("Move up", new ImageIcon(Utils.getImage("/arrow_up.png")));
        itemMoveDown = new JMenuItem("Move down", new ImageIcon(Utils.getImage("/arrow_down.png")));
        itemFind = new JMenuItem("Find...", new ImageIcon(Utils.getImage("/magnifier.png")));
        itemFindNext = new JMenuItem("Find Next", new ImageIcon(Utils.getImage("/magnifier_go.png")));
        itemAbout = new JMenuItem("About", new ImageIcon(Utils.getImage("/information.png")));
        ...
        buttonNew = new JButton(new ImageIcon(Utils.getImage("/page.png")));
        buttonReload = new JButton(new ImageIcon(Utils.getImage("/arrow_rotate_clockwise.png")));
        buttonOpen = new JButton(new ImageIcon(Utils.getImage("/folder_page.png")));
        buttonSave = new JButton(new ImageIcon(Utils.getImage("/disk.png")));
        buttonRename = new JButton(new ImageIcon(Utils.getImage("/textfield_rename.png")));
        buttonEdit = new JButton(new ImageIcon(Utils.getImage("/pencil.png")));
        buttonDelete = new JButton(new ImageIcon(Utils.getImage("/cross.png")));
        buttonTagByte = new JButton(new ImageIcon(Utils.getImage("/bullet_black.png")));
        buttonTagShort = new JButton(new ImageIcon(Utils.getImage("/bullet_red.png")));
        buttonTagInt = new JButton(new ImageIcon(Utils.getImage("/bullet_orange.png")));
        buttonTagLong = new JButton(new ImageIcon(Utils.getImage("/bullet_yellow.png")));
        buttonTagFloat = new JButton(new ImageIcon(Utils.getImage("/bullet_pink.png")));
        buttonTagDouble = new JButton(new ImageIcon(Utils.getImage("/bullet_purple.png")));
        buttonTagByteArray = new JButton(new ImageIcon(Utils.getImage("/arrows_black.png")));
        buttonTagIntArray = new JButton(new ImageIcon(Utils.getImage("/arrows_orange.png")));
        buttonTagString = new JButton(new ImageIcon(Utils.getImage("/text_smallcaps.png")));
        buttonTagList = new JButton("\u25BE", new ImageIcon(Utils.getImage("/note.png")));
        buttonTagCompound = new JButton(new ImageIcon(Utils.getImage("/package.png")));
        ...
        itemTagByte = new JMenuItem("Byte", new ImageIcon(Utils.getImage("/bullet_black.png")));
        itemTagShort = new JMenuItem("Short", new ImageIcon(Utils.getImage("/bullet_red.png")));
        itemTagInt = new JMenuItem("Int", new ImageIcon(Utils.getImage("/bullet_orange.png")));
        itemTagLong = new JMenuItem("Long", new ImageIcon(Utils.getImage("/bullet_yellow.png")));
        itemTagFloat = new JMenuItem("Float", new ImageIcon(Utils.getImage("/bullet_pink.png")));
        itemTagDouble = new JMenuItem("Double", new ImageIcon(Utils.getImage("/bullet_purple.png")));
        itemTagByteArray = new JMenuItem("ByteArray", new ImageIcon(Utils.getImage("/arrows_black.png")));
        itemTagIntArray = new JMenuItem("IntArray", new ImageIcon(Utils.getImage("/arrows_orange.png")));
        itemTagString = new JMenuItem("String", new ImageIcon(Utils.getImage("/text_smallcaps.png")));
        itemTagList = new JMenuItem("List", new ImageIcon(Utils.getImage("/note.png")));
        itemTagCompound = new JMenuItem("Compound", new ImageIcon(Utils.getImage("/package.png")));
